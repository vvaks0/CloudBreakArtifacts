...
instalHDFManagementPack () {
	wget http://s3.amazonaws.com/dev.hortonworks.com/HDF/centos7/3.x/BUILDS/3.1.0.0-247/tars/hdf_ambari_mp/hdf-ambari-mpack-3.1.0.0-247.tar.gz
ambari-server install-mpack --mpack=hdf-ambari-mpack-3.1.0.0-247.tar.gz --verbose
