...
class DemoControl(Script):
  ...
  def start(self, env):
    ...
    Execute('docker run -p -d '+params.ui_port+':8080 -e ATLAS_HOST='+params.atlas_host_ip+' -e ATLAS_PORT='+params.atlas_port+' -e API_HOST='+params.nifi_host_ip+' -e API_PORT='+params.api_port+' -t hortonworks/historian')
