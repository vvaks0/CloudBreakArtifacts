...
handleGroupProcessors (){
       	...
       	do
       		...
       		if ! [ -z $(echo $TYPE|grep "PutKafka") ] || ! [ -z $(echo $TYPE|grep "PublishKafka") ] || ! [ -z $(echo $TYPE|grep "ConsumeKafka") ] ; then
...
UPSERT INTO DEVICEDETAILS VALUES('1000','Motorolla','39.951694','-75.144596',''"$AMBARI_HOST"'','8085','None');

UPSERT INTO DEVICEDETAILS VALUES('2000','Motorolla','39.970279','-75.175152',''"$AMBARI_HOST"'','8087','None');

UPSERT INTO DEVICEDETAILS VALUES('3000','Motorolla','39.948174','-75.170689',''"$AMBARI_HOST"'','8089','None');
EOF
